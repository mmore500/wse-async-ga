...
export ASYNC_GA_TOURNSIZE_NUMERATOR=51/50
export ASYNC_GA_TOURNSIZE_DENOMINATOR=20
export ASYNC_GA_GLOBAL_SEED=${seed}
export COMPCONFENV_CEREBRASLIB_HSTRAT_DSTREAM_ALGO_NAME__comptime_string="hybrid_0_steady_1_circular_2_algo"
export COMPCONFENV_CEREBRASLIB_HSTRAT_T_DILATION__u32=256
