...
seed=0
for genome_flavor in genome_purifyingonly genome_purifyingsweep; do
    seed=$((seed + 1))
...
export ASYNC_GA_TOURNSIZE_NUMERATOR=21
export ASYNC_GA_TOURNSIZE_DENOMINATOR=20
export ASYNC_GA_GLOBAL_SEED=${seed}
export COMPCONFENV_CEREBRASLIB_HSTRAT_DSTREAM_ALGO_NAME__comptime_string="hybrid_0_steady_1_tilted_2_algo"
export COMPCONFENV_CEREBRASLIB_HSTRAT_T_DILATION__u32=32
